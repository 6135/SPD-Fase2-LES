    ...
    def clean(self):
        ...
        if password1 == None or password2 == None:
            ...
            if password1 == None:
                ...
                erros.append(
                    forms.ValidationError(f"As palavras-passe não correspondem")
                )
...
class ProfessorUniversitarioRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "faculdade" in self.data:
            ...
            self.fields[
                "departamento"
            ].queryset = self.instance.faculdade.departamento_set.order_by("nome")
...
class ColaboradorRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "faculdade" in self.data:
            ...
            self.fields["curso"].queryset = self.instance.faculdade.curso_set.order_by(
                "nome"
            )
...
class LoginForm(AuthenticationForm):
    username = CharField(
        widget=TextInput(attrs={"class": "input", "style": ""}),
        label="Nome de Utilizador",
        max_length=255,
        required=False,
    )
    password = CharField(
        widget=PasswordInput(attrs={"class": "input", "style": ""}),
        label="Senha",
        max_length=255,
        required=False,
    )
...
class RecuperarPasswordForm(Form):
    email = CharField(
        widget=EmailInput(attrs={"class": "input", "style": ""}),
        label="Email",
        max_length=255,
        required=False,
    )
...
class ParticipanteAlterarPerfilForm(ModelForm):
    class Meta:
        model = Participante
        fields = ("email", "first_name", "last_name", "contacto")
...
class AdministradorAlterarPerfilForm(ModelForm):
    class Meta:
        model = Administrador
        fields = ("email", "first_name", "last_name", "contacto", "gabinete")
