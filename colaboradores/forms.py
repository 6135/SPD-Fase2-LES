    ...
    def clean(self):
        ...
        if tarefa_auxiliar == "" and tarefa_acompanhar == "" and tarefa_outra == "":
            raise forms.ValidationError(
                f"Selecione pelo menos um tipo de tarefa pelo qual tenha preferência ou todas se não tiver nenhuma preferência"
            )
...
class colaboradorHorarioForm(models.ModelForm):
    ...
    def clean(self):
        ...
        if inicio > fim:
            raise forms.ValidationError(
                "O horário de inicio deve ser menor que o horário de fim"
            )
