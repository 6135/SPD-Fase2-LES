...
class TestNotificacoesUrls(TestCase):
    ...
    def test_url_sem_notificacoes(self):
        ...
        url = self.client.get(
            reverse("notificacoes:sem-notificacoes", kwargs={"id": 1})
        )
    ...
    def test_url_categorias_notificacao_automatica(self):
        ...
        url = self.client.get(
            reverse(
                "notificacoes:categorias-notificacao-automatica",
                kwargs={"id": 1, "nr": 1},
            )
        )
    ...
    def test_url_apagar_notificacao_automatica(self):
        ...
        url = self.client.get(
            reverse(
                "notificacoes:apagar-notificacao-automatica", kwargs={"id": 1, "nr": 1}
            )
        )
    ...
    def test_url_limpar_notificacoes(self):
        ...
        url = self.client.get(
            reverse("notificacoes:limpar-notificacoes", kwargs={"id": 1})
        )
    ...
    def test_url_criar_mensagem(self):
        ...
        url = self.client.get(
            reverse("notificacoes:escrever-mensagem", kwargs={"id": 1})
        )
    ...
    def test_url_criar_mensagem_uo(self):
        ...
        url = self.client.get(
            reverse("notificacoes:criar-mensagem-uo", kwargs={"id": 1})
        )
    ...
    def test_url_criar_mensagem_admin(self):
        ...
        url = self.client.get(
            reverse("notificacoes:criar-mensagem-admin", kwargs={"id": 1})
        )
    ...
    def test_url_criar_mensagem_participante(self):
        ...
        url = self.client.get(
            reverse("notificacoes:criar-mensagem-participante", kwargs={"id": 1})
        )
    ...
    def test_url_detalhes_mensagens(self):
        ...
        url = self.client.get(
            reverse("notificacoes:detalhes-mensagem", kwargs={"id": 1, "nr": 1})
        )
    ...
    def test_url_apagar_mensagem(self):
        ...
        url = self.client.get(
            reverse("notificacoes:apagar-mensagem", kwargs={"id": 1, "nr": 1})
        )
    ...
    def test_url_limpar_mensagens(self):
        ...
        url = self.client.get(
            reverse("notificacoes:limpar-mensagens", kwargs={"id": 1})
        )
