...
def create_material(atividade):
    return Materiais.objects.create(atividadeid=atividade, nomematerial="PC")


def create_material_1(atividade):
    return Materiais.objects.create(atividadeid=atividade, nomematerial="Rato")
...
class TestModels(TestCase):
    def setUp(self):
        ...
        self.atividade_1 = create_atividade_1(
            self.professor, self.diaaberto, self.espaco, self.tema
        )
