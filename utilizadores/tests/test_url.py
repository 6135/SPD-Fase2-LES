...
class TestUrlsConsultarUntilizadores(TestCase):
    ...
    def test_url_consultar_utilizadores(self):
        ...
        self.assertEquals(
            url.resolver_match.func.__name__, consultar_utilizadores.as_view().__name__
        )
...
class TestCriarUtilizadoresUrls(TestCase):
    ...
    def test_url_criar_utilizador(self):
        ...
        url = self.client.get(
            reverse("utilizadores:criar-utilizador", kwargs={"id": 1})
        )
    ...
    def test_url_concluir_registo(self):
        ...
        url = self.client.get(
            reverse("utilizadores:concluir-registo", kwargs={"id": 1})
        )
...
class TestApagarUtilizadorUrls(TestCase):
    ...
    def test_url_apagar_utilizador(self):
        ...
        url = self.client.get(
            reverse("utilizadores:apagar-utilizador", kwargs={"id": 1})
        )
...
class TestValidarRejeitarUrls(TestCase):
    ...
    def test_url_validar(self):
        ...
        url = self.client.get(
            reverse("utilizadores:validar-utilizador", kwargs={"id": 1})
        )
    ...
    def test_url_validar(self):
        ...
        url = self.client.get(
            reverse("utilizadores:rejeitar-utilizador", kwargs={"id": 1})
        )
...
class TestMensagensUrls(TestCase):
    ...
    def test_url_resolved(self):
        ...
        url = self.client.get(
            reverse("utilizadores:validar", kwargs={"nome": "andre", "id": 1})
        )
    ...
    def test_url_resolved(self):
        ...
        url = self.client.get(
            reverse("utilizadores:rejeitar", kwargs={"nome": "andre", "id": 1})
        )
...
class TestAlterarPerfilUrls(TestCase):
    ...
    def test_url_alterar_utilizador_admin(self):
        """Testes do url "rejeitar-utilizador" """
        url = self.client.get(
            reverse("utilizadores:alterar-utilizador-admin", kwargs={"id": 1})
        )
    ...
    def test_url_alterar_perfil_escolha(self):
        ...
        url = self.client.get(
            reverse("utilizadores:mudar-perfil-escolha-admin", kwargs={"id": 1})
        )
    ...
    def test_url_alterar_perfil_admin(self):
        ...
        url = self.client.get(
            reverse("utilizadores:mudar-perfil-admin", kwargs={"tipo": 1, "id": 1})
        )
    ...
    def test_url_alterar_perfil_escolha(self):
        ...
        url = self.client.get(
            reverse("utilizadores:mudar-perfil-escolha", kwargs={"id": 1})
        )
...
class TestLoginUrls(TestCase):
    ...
    def test_url_logout(self):
        ...
        response = self.client.get(reverse("utilizadores:logout"))
