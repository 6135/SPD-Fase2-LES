...
class TagTeste(TestCase):
    ...
    def setUp(self):
        self.nr_mensagem = 1
        self.emissor = User.objects.create_user(
            username="emissor", password="andre123456", email="teste@teste.pt"
        )
        self.recetor = User.objects.create_user(
            username="recetor", password="andre123456", email="teste@teste.pt"
        )
