...
urlpatterns = [
    path(
        "minhasatividades", views.AtividadesProfessor.as_view(), name="minhasAtividades"
    ),
    path(
        "atividadadesUOrganica",
        views.AtividadesCoordenador.as_view(),
        name="atividadesUOrganica",
    ),
    ...
    path(
        "eliminaratividade/<int:id>", views.eliminarAtividade, name="eliminarAtividade"
    ),
    ...
    path(
        "validaratividade/<int:id>/<int:action>",
        views.validaratividade,
        name="validarAtividade",
    ),
