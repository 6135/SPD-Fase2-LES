...
class NotificacaoTestEnviarMensagens(TestCase):
    ...
    def setUp(self):
        self.user_recipient = Utilizador(
            username="andreeee1",
            password="andre123456",
            email="test_notificacoes@test_notificacoes.pt",
            contacto="+351967321393",
            valido="True",
        )
        self.user_emissor = Utilizador(
            username="andreeeeeeee1",
            password="andre123456",
            email="test_notificacoes@test_notificacoes.pt",
            contacto="+351967321393",
            valido="True",
...
class NotificacaoTestGrupos(TestCase):
    ...
    def setUp(self):
        ...
        self.emissor = User.objects.create(
            username="andre2",
            password="andre123456",
            email="test_notificacoes@test_notificacoes.pt",
        )
        self.recetor = User.objects.create(
            username="andre3",
            password="andre123456",
            email="test_notificacoes@test_notificacoes.pt",
        )
    ...
    def test_marcar_como_lido_com_soft_delete(self):
        ...
        to_delete.save()
        self.assertTrue(
            Notificacao.objects.filter(recipient=self.recetor).order_by("id")[0].unread
        )
        Notificacao.objects.filter(recipient=self.recetor).mark_all_as_read()
        self.assertFalse(
            Notificacao.objects.filter(recipient=self.recetor).order_by("id")[0].unread
...
class NotificacaoTestTimezone(TestCase):
    ...
    def test_timezone(self):
        emissor = User.objects.create(
            username="andre",
            password="andre123456",
            email="test_notificacoes@test_notificacoes.pt",
        )
        recetor = User.objects.create(
            username="recetor",
            password="andre123456",
            email="test_notificacoes@test_notificacoes.pt",
        )
