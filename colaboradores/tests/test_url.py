...
class TestColaboradoresUrls(TestCase):
    ...
    def test_url_consultar_tarefas(self):
        ...
        self.assertEquals(
            url.resolver_match.func.__name__, consultar_tarefas.as_view().__name__
        )

    def test_url_concluir_tarefa(self):
        """Testes do url "concluir-tarefa" """
        url = self.client.get(
            reverse("colaboradores:concluir-tarefa", kwargs={"id": 1})
        )
    ...
    def test_url_cancelar_tarefa(self):
        ...
        url = self.client.get(
            reverse("colaboradores:cancelar-tarefa", kwargs={"id": 1})
        )
    ...
    def test_url_rejeitar_cancelamento_tarefa(self):
        ...
        url = self.client.get(
            reverse(
                "colaboradores:rejeitar-cancelamento-tarefa",
                kwargs={"id_notificacao": 1},
            )
        )
    ...
    def test_url_validar_cancelamento_tarefa(self):
        ...
        url = self.client.get(
            reverse(
                "colaboradores:validar-cancelamento-tarefa",
                kwargs={"id_notificacao": 1},
            )
        )
