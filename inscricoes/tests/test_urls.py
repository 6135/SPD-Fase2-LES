...
class TestInscricoesUrls(TestCase):
    ...
    def test_url_criar_inscricao(self):
        ...
        self.assertEqual(
            response.resolver_match.func.__name__, CriarInscricao.as_view().__name__
        )
    ...
    def test_url_minhas_inscricoes(self):
        ...
        self.assertEqual(
            response.resolver_match.func.__name__, MinhasInscricoes.as_view().__name__
        )
    ...
    def test_url_inscricoes_departamento(self):
        ...
        self.assertEqual(
            response.resolver_match.func.__name__, InscricoesUO.as_view().__name__
        )
    ...
    def test_url_inscricoes_admin(self):
        ...
        self.assertEqual(
            response.resolver_match.func.__name__, InscricoesAdmin.as_view().__name__
        )
    ...
    def test_url_consultar_inscricao(self):
        ...
        self.assertEqual(
            response.resolver_match.func.__name__, ConsultarInscricao.as_view().__name__
        )
    ...
    def test_url_alterar_inscricao_2(self):
        ...
        response = self.client.get(
            reverse(
                "inscricoes:alterar-inscricao", kwargs={"pk": inscricao.pk, "step": 0}
            )
        )
        self.assertEqual(
            response.resolver_match.func.__name__, ConsultarInscricao.as_view().__name__
