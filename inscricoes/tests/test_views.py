...
from inscricoes.tests.test_models import (
    create_Escola_0,
    create_Inscricao_0,
    create_Inscricao_1,
...
class TestInscricaoPDFView(TestCase):
    ...
    def test_InscricaoPDF_GET_inscricaoNaoExiste(self):
        ...
        self.assertRedirects(response, reverse("utilizadores:mensagem", args=[404]))
    ...
    def test_InscricaoPDF_GET_naoParticipanteCoordenadorAdministradorColaborador(self):
        ...
        utilizadores = [create_Utilizador_0(), create_ProfessorUniversitario_0()]
    ...
    def test_InscricaoPDF_GET_ok(self):
        ...
        self.assertEquals(response.context["ano"], self.inscricao.diaaberto.ano)
...
class TestAtividadesAPIView(TestCase):
    ...
    def test_AtividadesAPI_GET_atividade(self):
        ...
        response = self.client.get(reverse("inscricoes:api-atividades"), format="json")
        self.assertEqual(response.status_code, 200)
...
class TestCriarInscricaoView(TestCase):
    ...
    def test_CriarInscricao_GET_naoHaDiaAberto(self):
        ...
        participante = create_Participante_0()
        self.client.force_login(participante)
        response = self.client.get(reverse("inscricoes:criar-inscricao"), follow=True)
        self.assertTemplateUsed(response, "mensagem.html")
        self.assertEquals(response.context["tipo"], "error")
        self.assertEquals(
    ...
    @mock.patch(
        "inscricoes.views.datetime",
        Mock(now=Mock(return_value=datetime(2020, 1, 1, 9, 30, tzinfo=pytz.UTC))),
    )
    def test_CriarInscricao_GET_antesDoPeriodoDeInscricoes(self):
        ...
        self.assertEquals(
            response.context["m"],
            f"Período de abertura das inscrições: 01/01/2021 até 01/03/2021",
        )

    @mock.patch(
        "inscricoes.views.datetime",
        Mock(now=Mock(return_value=datetime(2021, 4, 1, 9, 30, tzinfo=pytz.UTC))),
    )
    ...
    def test_CriarInscricao_POST_naoHaDiaAberto(self):
        ...
        participante = create_Participante_0()
        self.client.force_login(participante)
        response = self.client.post(reverse("inscricoes:criar-inscricao"), follow=True)
        self.assertTemplateUsed(response, "mensagem.html")
        self.assertEquals(response.context["tipo"], "error")
        self.assertEquals(
            response.context["m"], "Ainda não é permitido criar inscrições"
    ...
    def test_CriarInscricao_POST_semVariaveis(self):
        ...
        self.assertTemplateUsed(response, "mensagem.html")
        self.assertEquals(response.context["tipo"], "error")
        self.assertEquals(response.context["m"], f"Erro no servidor")
    ...
    def test_CriarInscricao_POST_info_ok(self):
        ...
        response = self.client.post(
            reverse("inscricoes:criar-inscricao"),
            {"criar_inscricao-current_step": ["info"], "info-individual": ["True"]},
            follow=True,
        )
    ...
    def test_CriarInscricao_POST_info_individual_ok(self):
        ...
        participante = create_Participante_0()
        self.client.force_login(participante)
        POST = {"criar_inscricao-current_step": ["info"], "info-individual": ["True"]}
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
        self.assertTemplateUsed(
            response, "inscricoes/inscricao_wizard_responsaveis.html"
        )
        self.assertIsNotNone(response.context["wizard"])
    ...
    def test_CriarInscricao_POST_responsaveis_ok(self):
        ...
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
        self.assertTemplateUsed(response, "inscricoes/inscricao_wizard_escola.html")
        self.assertFalse(response.context["form"].errors)
    ...
    def test_CriarInscricao_POST_escola_ok(self):
        ...
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
        self.assertTemplateUsed(response, "inscricoes/inscricao_wizard_transporte.html")
        self.assertFalse(response.context["form"].errors)
    ...
    def test_CriarInscricao_POST_transporte_ok(self):
        ...
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
        self.assertTemplateUsed(response, "inscricoes/inscricao_wizard_almoco.html")
        self.assertFalse(response.context["form"].errors)
    ...
    def test_CriarInscricao_POST_almoco_ok(self):
        ...
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
        self.assertTemplateUsed(response, "inscricoes/inscricao_wizard_sessoes.html")
        self.assertFalse(response.context["form"].errors)
    ...
    def test_CriarInscricao_POST_sessoes_erroMaisInscritosQueVagas(self):
        ...
        POST = {
            "criar_inscricao-current_step": ["sessoes"],
            "sessoes-sessoes": [
                '{"' + str(sessao.id) + '": ' + str(sessao.vagas + 1) + "}"
            ],
            "sessoes-sessoes_info": ["[]"],
        }
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
    ...
    def test_CriarInscricao_POST_sessoes_erroHorariosSobrepostos(self):
        ...
        POST = {
            "criar_inscricao-current_step": ["sessoes"],
            "sessoes-sessoes": [
                '{"' + str(sessao0.id) + '": 20,"' + str(sessao1.id) + '": 20}'
            ],
            "sessoes-sessoes_info": ["[]"],
        }
        response = self.client.post(reverse("inscricoes:criar-inscricao"), POST)
    ...
    def test_CriarInscricao_POST_sessoes_ok(self):
        ...
        POST = {
            "criar_inscricao-current_step": ["sessoes"],
            "sessoes-sessoes": [
                '{"' + str(sessao0.id) + '": 10,"' + str(sessao1.id) + '": 20}'
            ],
            "sessoes-sessoes_info": ["[]"],
        }
        response = self.client.post(
...
class TestConsultarAlterarInscricaoView(TestCase):
    ...
    def test_ConsultarInscricao_GET_naoParticipanteCoordenadorAdministrador(self):
        ...
        for utilizador in utilizadores:
            ...
            response = self.client.get(
                reverse(
                    "inscricoes:consultar-inscricao", kwargs={"pk": self.inscricao.pk}
                )
            )
            self.assertTemplateUsed(response, "mensagem.html")
            self.assertEquals(response.context["tipo"], "error")
    ...
    def test_AlterarInscricao_POST_depoisDoPeriodoDeInscricoes(self):
        ...
        self.assertEquals(response.context["tipo"], "error")
        self.assertEquals(
            response.context[-1]["m"],
            f"Não pode alterar a inscrição fora do período: 01/01/2021 até 01/03/2021",
        )
    ...
    def test_AlterarInscricao_POST_escola_erroCamposVazios(self):
        ...
        self.assertTemplateUsed(response, "inscricoes/consultar_inscricao_escola.html")
        self.assertTrue(response.context["form"].errors)
    ...
    def test_AlterarInscricao_POST_almoco_erroCampusEscolhidoMasSemPessoas(self):
        ...
        self.assertTemplateUsed(response, "inscricoes/consultar_inscricao_almoco.html")
        self.assertTrue(response.context["form"].errors)
    ...
    def test_AlterarInscricao_POST_sessoes_erroSemVariáveis(self):
        ...
        self.assertTemplateUsed(response, "inscricoes/consultar_inscricao_sessoes.html")
        self.assertTrue(response.context["form"].errors)
