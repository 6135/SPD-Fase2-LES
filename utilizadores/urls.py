...
urlpatterns = [
    path(
        ...
        consultar_utilizadores.as_view(),
    ...
    path(
        "apagarproprioutilizador", views.apagar_proprio_utilizador, name="apagar-conta"
    ),
    path(
        "apagarutilizador/<int:id>", views.apagar_utilizador, name="apagar-utilizador"
    ),
    path(
        "alterarutilizadoradmin/<int:id>",
        views.alterar_utilizador_admin,
        name="alterar-utilizador-admin",
    ),
    path("alterarutilizador", views.alterar_utilizador, name="alterar-utilizador"),
    path(
        "validarutilizador/<int:id>",
        views.validar_utilizador,
        name="validar-utilizador",
    ),
    path(
        "rejeitarutilizador/<int:id>",
        views.rejeitar_utilizador,
    ...
    path(
        "mudarperfilescolha/<int:id>",
        views.mudar_perfil_escolha_admin,
        name="mudar-perfil-escolha-admin",
    ),
    path(
        "mudarperfil/<int:tipo>/<int:id>",
        views.mudar_perfil_admin,
        name="mudar-perfil-admin",
    ),
    path(
        "mudarmeuperfilescolha", views.mudar_perfil_escolha, name="mudar-perfil-escolha"
    ),
    path("mudarmeuperfil/<int:tipo>", views.mudar_perfil, name="mudar-perfil"),
    path(
        "ajax/load-departamentos/",
        views.load_departamentos,
        name="ajax_load_departamentos",
    ),
