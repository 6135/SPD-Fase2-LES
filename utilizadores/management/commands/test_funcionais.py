...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "tests_path", type=str, help="Especifica os sítios ou app dos testes"
        )
        parser.add_argument(
            "browser", type=str, help="O browser no qual correr os testes"
        )
        ...
        parser.add_argument("-k", "--keepdb", action="store_true", help="Manter a db")
    ...
    def handle(self, *args, **options):
        ...
        call_command("test", tests_path, *_args)
