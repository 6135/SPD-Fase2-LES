    ...
    def test_criar_inscricao_1(self):
        ...
        assert (
            self.driver.find_element(
                By.CSS_SELECTOR, ".button:nth-child(2) > span:nth-child(2)"
            ).text
            == "Escola (Turma)"
        )
        self.driver.find_element(
        ...
        assert (
            self.driver.find_element(
                By.CSS_SELECTOR, ".column:nth-child(1) .label"
            ).text
            == "Nome"
        )
        assert (
            self.driver.find_element(
                By.CSS_SELECTOR, ".column:nth-child(2) .label"
            ).text
            == "E-mail"
        )
        ...
        self.driver.find_element(
            By.CSS_SELECTOR, ".is-success > span:nth-child(1)"
        ).click()
        # escola
        ...
        time.sleep(1)
        self.driver.find_element(
            By.CSS_SELECTOR, ".is-selectable:nth-child(6) > span"
        ).click()
        self.driver.find_element(By.CSS_SELECTOR, ".b-numberinput .input").click()
        self.driver.find_element(By.CSS_SELECTOR, ".b-numberinput .input").send_keys(
            "2"
        )
        self.driver.find_element(By.ID, "id_escola-nome_escola").click()
        self.driver.find_element(By.ID, "id_escola-nome_escola").send_keys(
            "Judice Fialho"
        )
        ...
        self.driver.find_element(By.ID, "id_escola-areacientifica").send_keys(
        ...
        assert element.is_enabled() is True
        value = self.driver.find_element(By.ID, "id_escola-nome_escola").get_attribute(
            "value"
        )
        assert value == "Judice Fialho"
        value = self.driver.find_element(
            By.ID, "id_escola-areacientifica"
        ).get_attribute("value")
        ...
        dropdown = Select(
            self.driver.find_element(By.CSS_SELECTOR, ".control:nth-child(1) select")
        )
        ...
        dropdown = Select(
            self.driver.find_element(By.CSS_SELECTOR, ".is-empty > select")
        )
        dropdown.select_by_visible_text("30")
        assert (
            self.driver.find_element(By.CSS_SELECTOR, ".is-4 .label").text
            == "Meio de transporte"
        )
        value = self.driver.find_element(
            By.NAME, "transporte-local_chegada"
        ).get_attribute("value")
        ...
        self.driver.find_element(By.NAME, "almoco-npratosalunos").send_keys("1")
        # self.driver.find_element(By.NAME, "almoco-npratosdocentes").click()
        # self.driver.find_element(
        #     By.NAME, "almoco-npratosdocentes").send_keys("1")
        assert (
            self.driver.find_element(By.CSS_SELECTOR, ".is-5 .label").text == "Campus"
        )
        ...
        self.driver.find_element(
            By.CSS_SELECTOR, "tr:nth-child(1) > td:nth-child(3) .input"
        ).send_keys("1")
