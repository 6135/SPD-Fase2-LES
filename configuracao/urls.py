...
urlpatterns = [
    ...
    path(
        "atribuirtransporte/<int:id>",
        views.atribuirTransporte,
        name="atribuirTransporte",
    ),
    path(
        "eliminaratribuicao/<int:id>",
        views.eliminarAtribuicao,
        name="eliminarAtribuicao",
    ),
    path(
        "eliminartransporte/<int:id>",
        views.eliminarTransporte,
        name="eliminarTransporte",
    ),
    # -Utility
    path(
        "imagens/edificio/<int:id>", views.verEdificioImagem, name="verEdificioImagem"
    ),
    ...
    path(
        ...
        views.configurarDepartamento,
        name="adicionarDepartamento",
    ),
    path(
        "editarDepartamento/<int:id>",
        views.configurarDepartamento,
        name="editarDepartamento",
    ),
    path(
        "eliminarDepartamento/<int:id>",
        views.eliminarDepartamento,
    ...
    path(
        "ajax/addDepartamentoRow",
        views.newDepartamentoRow,
        name="ajaxAddDepartamentoRow",
    ),
